...
```text
uf-product-macros  (uf_app!, #[server], search/permission macros)
        │
        ▼
...
| [`uf-notifications`](uf-notifications/) | Bell, unread badge, and `/notifications` inbox UI (domain persist/API in [uf-notifications](https://github.com/unified-field-dev/uf-notifications)) |
...
| [`uf-product-ui-e2e`](uf-product-ui-e2e/) | In-workspace Playwright product UI scenarios |
